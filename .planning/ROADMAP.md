...
- [ ] **Phase 1: Login & Image Viewer** - Known team members log in and view a real DICOM image at original resolution
- [ ] **Phase 2: Bounding Box Drawing Interface** - Draw, resize, and delete a single bounding box per image with rock-solid auto-save
- [ ] **Phase 3: Navigation & Progress Tracking** - Move through the full sequential dataset with a progress bar and a completion message
- [ ] **Phase 4: Export to COCO JSON** - Produce a single COCO JSON export of all annotations for downstream ML training
...
|-------|----------------|--------|-----------|
| 1. Login & Image Viewer | 0/TBD | Not started | - |
| 2. Bounding Box Drawing Interface | 0/TBD | Not started | - |
| 3. Navigation & Progress Tracking | 0/TBD | Not started | - |
| 4. Export to COCO JSON | 0/TBD | Not started | - |
